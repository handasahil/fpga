...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("C_address0", 14, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("C_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("C_we0", 1, hls_out, 1, "ap_memory", "mem_we", 1),
	Port_Property("C_d0", 24, hls_out, 1, "ap_memory", "mem_din", 1),
};

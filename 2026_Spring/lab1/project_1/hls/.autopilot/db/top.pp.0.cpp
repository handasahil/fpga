...
__attribute__((sdx_kernel("top_kernel", 0))) void top_kernel(data_t A[256][64],
                data_t C[256][64]) {
#line 22 "/nethome/shanda34/FPGA_ECE8893/2026_Spring/lab1/script.tcl"
...
# 6 "top.cpp"
    ...
    VITIS_LOOP_11_1: for (int i = 0; i < 256; i++) {
        ...
        VITIS_LOOP_15_2: for (int j = 0; j < 64; j++) {
#pragma HLS PIPELINE II=1
 row_sum += A[i][j];
        ...
        VITIS_LOOP_24_3: for (int j = 0; j < 64; j++) {
#pragma HLS PIPELINE II=1
 tmp[i][j] = A[i][j] / denom;
        }
    }
    ...
    VITIS_LOOP_31_4: for (int j = 0; j < 64; j++) {
        data_t col_sum = 0.0;
